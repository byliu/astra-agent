...
-- Updated: 2025-10-28 - Removed unique constraint (moved to application layer)
...
-- NOTE: Unique constraint on (bot_id, version) removed as of 2025-10-28
-- Data uniqueness is now managed by upstream application layer
-- Previous constraint: ALTER TABLE bot_config ADD UNIQUE KEY uniq_bot_id_version (bot_id, version);
...
-- NOTE: uniq_bot_id_version constraint verification removed (constraint no longer exists)
